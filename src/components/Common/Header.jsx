...
export const Header = ({ image, title, subtitle, buttontext }) => {
    ...
    <div className="header-container">
      ...
      <div className="header-content" data-aos="fade-up">
        ...
        {subtitle ? (
          ...
          <p className="header-subtitle">Home / {formatPath(location.pathname)}</p>
        )}
        {buttontext && <SecondaryButton label={buttontext} />}
      </div>  
      <img className="header-design" 
      // data-aos="slide-up" 
      // data-aos-duration="2000"
       src={HeroDesign} alt="Header Background" />
